  ...
  return (
    <div className="px-[26px] py-[22px] max-w-[1040px]">
      ...
      <div className="flex items-baseline justify-between mb-4">
        ...
        {d.firstName && (
          <span className="font-mono text-[14px] text-stone">{d.greeting}, {d.firstName}</span>
        )}
      </div>

      {/* Context row — kept from the original dashboard */}
      ...
      {/* Redesigned agenda (Option A) — week strip + spine */}
      <AgendaA d={d} />

      {/* Lower panels */}
      <div className="mt-2"><DashboardExtras d={d} /></div>
