        ...
        <div className="grid sm:grid-cols-2 gap-[14px]">
          {cards.map(({ guide, plan }) => {
            ...
            return (
              ...
              >
                <div className="bg-oxblood px-[20px] py-[16px] flex items-start justify-between gap-4">
                  <div>
                    <h2 className="font-display font-semibold text-[20px] text-bone leading-tight">{guide.eventName}</h2>
