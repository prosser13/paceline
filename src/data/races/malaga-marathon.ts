...
export const MALAGA_MARATHON: RaceGuide = {
  ...
  checkpoints: [
    { index: 0, name: 'Start · Paseo del Parque', distanceKm: 0, ascentM: 0,
      supplies: 'Box 2 (red), 08:30 start.' },
    { index: 1, name: '5 km', distanceKm: 5, ascentM: 18, supplies: 'Water station.',
      fuelBetween: 'Settle into goal pace — no rush, hold 3:47.', fuelAt: 'Water.' },
    { index: 2, name: '10 km', distanceKm: 10, ascentM: 35, supplies: 'Water station.',
      fuelBetween: 'First fuel by ~8 km: 1 pack Beta Fuel chews (46 g).', fuelAt: 'Water.' },
    { index: 3, name: '15 km', distanceKm: 15, ascentM: 55, supplies: 'Water + isotonic.',
      fuelBetween: 'Hi5 gel (23 g).', fuelAt: 'Water / isotonic.' },
    { index: 4, name: '20 km', distanceKm: 20, ascentM: 78, supplies: 'Water station.',
      fuelBetween: 'Beta Fuel chews (46 g). Halfway ~1:20 — check you’re on pace.', fuelAt: 'Water.' },
    { index: 5, name: '25 km', distanceKm: 25, ascentM: 98, supplies: 'Water + isotonic.',
      fuelBetween: 'Hi5 gel (23 g).', fuelAt: 'Water.' },
    { index: 6, name: '30 km', distanceKm: 30, ascentM: 112, supplies: '226ers gel station (55 g). Water.',
      fuelBetween: 'Run in light — the big top-up is here.', fuelAt: '226ers gel — grab 2, take one now (55 g).' },
    { index: 7, name: '35 km', distanceKm: 35, ascentM: 124, supplies: 'Water + isotonic.',
      fuelBetween: '226ers #2 (55 g) around 36 km.', fuelAt: 'Water.' },
    { index: 8, name: '40 km', distanceKm: 40, ascentM: 134, supplies: 'Water station.',
      fuelBetween: 'Spare Hi5 (23 g) only if you want a final lift.', fuelAt: 'Water — then empty the tank.' },
    { index: 9, name: 'Finish · Paseo del Parque', distanceKm: 42.2, ascentM: 140, supplies: 'Finish on the Paseo del Parque.',
