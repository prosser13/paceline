...
export default function YogaHero({
  ...
  return (
    <div className="border border-fog rounded-[18px] overflow-hidden bg-paper mb-[18px]">
      ...
      <div className="flex items-center justify-between px-[26px] py-[12px]" style={{ background: done ? FERN : EMBER, color: BONE }}>
      ...
      <div className="p-[22px_26px]">
        ...
        <div className="mt-[18px]">
          <button type="button" onClick={() => setOpen(o => !o)} className="flex items-center gap-[8px] cursor-pointer select-none">
            <span className="font-mono text-[13px] tracking-[.12em] uppercase text-stone">The flow</span>
